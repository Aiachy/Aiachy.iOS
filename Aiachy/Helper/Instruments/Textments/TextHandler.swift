...
struct TextHandler {
    ...
    static func makeZodiacString(aiachy aiachyState: AiachyState, zodiac: textHelperZodiacCompletion.zodiac) -> String {
        ...
        case "DK":
            return Danish.zodiac[zodiac]!
        case "FR":
            return French.zodiac[zodiac]!
        case "DE":
            return German.zodiac[zodiac]!
        case "GR":
        ...
        case "PL":
            return Polish.zodiac[zodiac]!
        case "IT":
            return Italian.zodiac[zodiac]!
        case "RO":
            return Romanian.zodiac[zodiac]!
        case "RU":
            return Russian.zodiac[zodiac]!
        case "UA":
            return Ukrainian.zodiac[zodiac]!
        case "US":
            return EnglishUSA.zodiac[zodiac]!
        default:
            return EnglishUSA.zodiac[zodiac]!
