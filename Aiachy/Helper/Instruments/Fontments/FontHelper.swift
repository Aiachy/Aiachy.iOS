...
struct FontHelper {
    ...
    static var CinzelBlack11: Font = .custom(FontHelper().CinzelBlack, size: 11)
    static var CinzelBlack12: Font = .custom(FontHelper().CinzelBlack, size: 12)
    ...
    static var CinzelBlack25: Font = .custom(FontHelper().CinzelBlack, size: 25)
    ...
    static var RoundedBold13: Font = .system(size: 13, weight: .bold, design: .rounded)
    ...
    static var RoundedBold17: Font = .system(size: 17, weight: .bold, design: .rounded)
