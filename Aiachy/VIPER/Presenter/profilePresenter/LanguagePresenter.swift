...
class LanguagePresenter: ObservableObject {
    ...
    private let router: ProfileRouterPresenter
    ...
    init(aiachy aiachyState: AiachyState,
        ...
        self.router = router
        self.interactor = LanguageInteractor(aiachy: aiachyState)
    ...
    func updateAiachyState(entity acyLanguageEntity: ACYLanguageEntity) {
        ...
        aiachyState.user.aiachyInfo.aiachyLanguageInfo.language = countryCode
...
extension LanguagePresenter: HandlerProtocol {
    ...
    fileprivate func makeUserConvertToLanguageEntity() {
        let languageCode = aiachyState.user.aiachyInfo.aiachyLanguageInfo.wrappedLanguage
    ...
    fileprivate func updateLocalLanguage(entity acyLanguageEntity: ACYLanguageEntity) {
        aiachyState.user.aiachyInfo.aiachyLanguageInfo.language = acyLanguageEntity.countryCode
        aiachyState.user.aiachyInfo.aiachyLanguageInfo.languageIdentifier =  acyLanguageEntity.localeIdentifier
    }
...
extension LanguagePresenter: ServerProtocol {
    ...
    /// - Parameter acyLanguageEntity: usign setted enttiy 
    fileprivate func updateUserLanguageOnServer(entity acyLanguageEntity: ACYLanguageEntity) {
        interactor.updateUserLanguage(entity: acyLanguageEntity)
    }
}
