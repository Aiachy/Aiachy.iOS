...
class CrystalSelectionPresenter: ObservableObject {
    ...
    @Published var selectedCrystalName: TextHelper.SpiritualCompletion.crystal?
...
extension CrystalSelectionPresenter {
    ...
    func selectedZodiacToInt(selectedZodiac: TextHelper.SpiritualCompletion.crystal) -> Int {
